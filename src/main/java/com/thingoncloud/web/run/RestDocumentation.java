...
public class RestDocumentation implements SparkApplication {
	...
	public void init() {
		...
		get("/", (rq, rs) -> "default route for documentation");
		...
		get("/hello2", (req, res) -> "bla, bla documentation");	
	...
	public static void main(String[] args) {
		RestDocumentation wa = new RestDocumentation();
		wa.init();
	}
}
